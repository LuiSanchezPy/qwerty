...
# Traerms ciudades de Pagopar    
    ...
    // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching -- Consulta directa necesaria para la tabla personalizada wp_pagopar_zonas_envio del plugin Pagopar, sin equivalente en APIs de WordPress.
    ...
    if (!is_numeric($pagoparZonasEnvio[0]['id'])) {
        ...
        $format = array('%d', '%d', '%d');
        // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching -- Inserción directa necesaria para la tabla personalizada wp_pagopar_zonas_envio del plugin Pagopar, sin equivalente en APIs de WordPress.
        ...
        // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching -- Actualización directa necesaria para la tabla personalizada wp_pagopar_zonas_envio del plugin Pagopar, sin equivalente en APIs de WordPress.
        $wpdb->update(
    ...
    if (is_numeric($zonaIdInsertada)) {
        ...
        // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching -- Consulta directa necesaria para la tabla personalizada wp_pagopar_ciudades_x_metodos_zonas_envio del plugin Pagopar, sin equivalente en APIs de WordPress.
        ...
        foreach ($ciudadesABorrar as $key => $value) {
            ...
            // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching -- Eliminación directa necesaria para la tabla personalizada wp_pagopar_ciudades_x_metodos_zonas_envio del plugin Pagopar, sin equivalente en APIs de WordPress.
        ...
        foreach ($ciudadesAAgregar as $key => $value) {
            ...
            $format = array('%d', '%d', '%d');
            // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching -- Inserción directa necesaria para la tabla personalizada wp_pagopar_ciudades_x_metodos_zonas_envio del plugin Pagopar, sin equivalente en APIs de WordPress.
