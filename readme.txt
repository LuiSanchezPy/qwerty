...
Donate link: 
Tags: pagopar, bancard, pix, upay, tarjetas de credito y billeteras electronicas, paraguay
...
Luego, deberías simular una venta, para ello, creas un pedido en tu wordpress, te redirige a la web de Pagopar. Luego, estando en tu panel en "Integrar con mi sitio web", sin cerrar la página anterior, y le das en "Simular pago", ejemplo, seleccionando "Aquipago", una vez hecho esto, volvés al checkout, elegis "Aquipago" y luego click en "Volver al sitio web". Una vez hecho todo esto, ya vas a cumplir los tres pasos necesarios para pasar a producción tu comercio. Te debería marcar chequeado los tres pasos y ahí agregás la IP donde está tu sitio y le das "Pasar a Producción". 
...
= 2.8.13 =
* Modificado: Se soluciona problema al listar medios de pago que ocurria en ciertos casos

= 2.8.12 =
* Modificado: Se soluciona problema de campos en checkout blocks

= 2.8.11 =
* Modificado: Se soluciona problema de campos en checkout classic

= 2.8.10 =
* Modificado: Se soluciona problema de medios de pago en bloques

= 2.8.9 =
* Modificado: Se soluciona problema de billing_documento que ocurria en ciertos casos

= 2.8.8 =
* Modificado: Se soluciona problema de cache de formas de pagos

= 2.8.7 =
* Modificado: Compatibilidad alto rendimiento

= 2.8.6 =
* Modificado: No se muestra innecesariamente tarjetas guardadas y tarjetas con promocion

= 2.8.5 =
* Modificado: Se escapa correctamente bloque HTML sobre reintegro

= 2.8.4 =
* Modificado: Se aplican recomendaciones de seguridad

= 2.8.3 =
* Modificado: Se aplican recomendaciones de seguridad

= 2.8.2 =
* Modificado: Se arregla visualizacion de medios de pagos

= 2.8.1 =
* Agregado: Se aplican recomendaciones de seguridad

= 2.8.0 =
* Agregado: Se aplican recomendaciones de seguridad
* Agregado: Se muestra promociones en caso de corresponder
