...
if (settingsPagopar.medios_pago.hasOwnProperty(medio_pago)) {
    ...
    const Content = (props) => {
            ...
            const unsubscribe = onPaymentSetup(async () => {
                ...
                if (selectedPaymentMethod) {
                    ...
                    return {
                        ...
                        meta: {
                            paymentMethodData: {
                                "wc-pagopar_bancard_qr-new-payment-method": selectedValue // Enviar el valor del input seleccionado
                            },
                        },
                    };
                }
        ...
        const additionalContent = additionalKeys.map((adKey) => {
            ...
            var element = createElement('li', { key: adKey, style: { display: isSingleItem ? 'none' : '' } },
                createElement('label', {
