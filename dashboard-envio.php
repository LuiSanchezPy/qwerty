...
if (isset($_GET['editar'])){
    ...
    $direccion_unica_habilitada = sanitize_text_field(get_option('direccion_unica_habilitada'));
    $pagopar_aex_activo_general = sanitize_text_field(get_option('pagopar_aex_activo_general'));
    $pagopar_mobi_activo_general = sanitize_text_field(get_option('pagopar_mobi_activo_general'));
    $pagopar_aex_comentario_pickup = sanitize_text_field(get_option('pagopar_aex_comentario_pickup'));
    $pagopar_envio_propio_tiempo_entrega = sanitize_text_field(get_option('pagopar_envio_propio_tiempo_entrega'));
...
<script>
    function editarDireccion(){
        ...
        window.location = "<?php echo esc_url($urlAdmin).'&editar&direccion='?>"  + direccion_id;
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp">
                            <fieldset>
                                ...
                                <label for="direccion">
                                    <input  class="" type="text" name="direccion" id="direccion" style="" value="<?php echo esc_attr($direcciones[0]->direccion);?>" />
                                </label><br/>
                        ...
                        <td class="forminp">
                            <fieldset>
                                ...
                                <label for="direccion_referencia">
                                    <input  class="" type="text" name="direccion_referencia" id="direccion_referencia" style="" value="<?php echo esc_attr($direcciones[0]->direccion_referencia);?>" />
                                </label><br/>
                        ...
                        <td class="forminp">
                            <fieldset>
                                ...
                                <label for="direccion_telefono">
                                    <input  class="" type="text" name="direccion_telefono" id="direccion_telefono" style="" value="<?php echo esc_attr($direcciones[0]->telefono);?>" />
                                </label><br/>
                            ...
                            <fieldset>
                                ...
                                <select class="select wc-enhanced-select" name="ciudad" id="ciudad" style="" tabindex="-1" aria-hidden="true">
                                    <?php foreach ($cities_wc_format as $key => $value) : ?>
                                        <option value="<?php echo esc_attr($key); ?>" <?php if ($key == $direcciones[0]->ciudad): echo ' selected="selected" '; endif;?> ><?php echo esc_html($value); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </fieldset>
                        </td>
                        ...
                        <td class="forminp">
                            <fieldset>
                                ...
                                <label for="direccion_coordenadas">
                                    <input  class="" type="text" name="direccion_coordenadas" id="direccion_coordenadas" style="" value="<?php echo esc_attr($direcciones[0]->direccion_coordenadas);?>" />
                                </label><br/>
                ...
                <table class="form-table" id="tblDoc">
                            ...
                            <fieldset>
                                ...
                                <select class="select wc-enhanced-select" name="pagopar_direccion_id" id="pagopar_direccion_id" style="" tabindex="-1" aria-hidden="true">
                                    <?php foreach ($direcciones as $key => $value) : ?>
                                        <option value="<?php echo esc_attr($value->id); ?>" <?php if ($direccionDefecto->id === $value->id): echo ' selected="selected" '; endif;?> ><?php echo esc_attr($value->direccion); ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <a href="javascript:editarDireccion();">Editar esta dirección</a> &nbsp; | &nbsp; <a href="<?php echo esc_url($urlAdmin)?>&agregar">Agregar nueva dirección</a>
                            </fieldset>
                        </td>
                    </tr>
                        ...
                        <td class="forminp">
                            <fieldset>
                                ...
                                <label for="pagopar_aex_comentario_pickup">
                                    <input  class="" type="text" name="pagopar_aex_comentario_pickup" id="pagopar_aex_comentario_pickup" style="" value="<?php echo esc_attr($pagopar_aex_comentario_pickup)?>" /></label><br/>
                            </fieldset>
                        </td>
                    </tr>
                    ...
                    <?php if (false): ?>
                            ...
                            <td class="forminp">
                                <fieldset>
                                    ...
                                    <label for="pagopar_mobi_activo_general">
                                        ...
                                        <input class="hidden" id="pagopar_mobi_hora_contador" name="pagopar_mobi_hora_contador" value="<?php echo esc_attr($pagopar_mobi_hora_contador);?>">
				        ...
				        if (count((array)$pagopar_mobi_hora)):
                                    ...
                                    <tr valign="top" class="hora" id="hora_<?php echo esc_attr($var_vertical+1);?>">
                                    <th scope="row" class="titledesc">
                                    ...
                                    <?php $array_dias = explode(',',$pagopar_mobi_hora[$var_vertical]['dias']);?>
                                         ...
                                         <select class="select wc-enhanced-select" name="hora_mobi_inicio_<?php echo esc_attr($var_vertical+1);?>" id="hora_mobi_inicio_<?php echo esc_attr($var_vertical+1);?>" style="" tabindex="-1" aria-hidden="true">
                                             <?php
                                             foreach ($horarios as $key => $value) : ?>
                                                 <option value="<?php echo esc_html($value); ?>" <?php if ($pagopar_mobi_hora[$var_vertical]['hora_inicio'] === $value): echo ' selected="selected" '; endif;?> ><?php echo esc_html($value); ?></option>
                                             <?php endforeach; ?>
                                         </select>
                                         <select class="seqect wc-enhanced-select" name="hora_mobi_fin_<?php echo esc_attr($var_vertical+1);?>" id="hora_mobi_fin_<?php echo esc_attr($var_vertical+1);?>" style="" tabindex="-1" aria-hidden="true">
                                             <?php
                                             foreach ($horarios as $key => $value) : ?>
                                                 <option value="<?php echo esc_html($value); ?>" <?php if ($pagopar_mobi_hora[$var_vertical]['hora_fin'] === $value): echo ' selected="selected" '; endif;?> ><?php echo esc_html($value); ?></option>
                                             <?php  endforeach; ?>
                                         </select>
                                         ...
                                         <div class="franja-dias">
                                             <?php for($var_horizontal=1;$var_horizontal<8;$var_horizontal++):?>
                                                 <?php if(in_array($var_horizontal,$array_dias)==1):?>
                                                     <input  class="hidden" value="<?php echo esc_html($var_horizontal);?>" id="dia-<?php echo esc_html($var_horizontal);?>-<?php echo esc_attr($var_vertical+1);?>" name="dia-<?php echo esc_html($var_horizontal);?>-<?php echo esc_attr($var_vertical+1);?>"><span attr-val="1" class="dia dia-<?php echo esc_html($var_horizontal);?>-<?php echo esc_attr($var_vertical+1);?> active" style='background: rgb(154, 154, 161);'><?php echo esc_html($dias_letras[$var_horizontal]);?></span>
                                                 <?php else:?>
                                                     <input  class="hidden" id="dia-<?php echo esc_html($var_horizontal);?>-<?php echo esc_attr($var_vertical+1);?>" name="dia-<?php echo esc_html($var_horizontal);?>-<?php echo esc_attr($var_vertical+1);?>"><span attr-val="1" class="dia dia-<?php echo esc_html($var_horizontal);?>-<?php echo esc_attr($var_vertical+1);?>"><?php echo esc_html($dias_letras[$var_horizontal]);?></span>
                                                 <?php endif;?>
                                             <?php endfor;?>
                                         </div>
                                        <br>
                                            <button class="button-primary" type="button" id="agregar">+ AGREGAR HORARIO</button>
                                            <button class="button-primary rojo" type="button" id="borrar" data-value="<?php echo esc_attr($var_vertical+1);?>">- BORRAR HORARIO</button>
                                        </fieldset>
                                        </td>
                                        </tr>
                                     <?php endfor;?>
                        ...
                        <td class="forminp">
                            <fieldset>
                                ...
                                <label for="pagopar_envio_propio_tiempo_entrega">
                                    <input  class="" type="text" name="pagopar_envio_propio_tiempo_entrega" id="pagopar_envio_propio_tiempo_entrega" style="" value="<?php echo esc_attr($pagopar_envio_propio_tiempo_entrega);?>" placeholder="Ejemplo: 24" /> </label><br/>
                            </fieldset>
                        </td>
                    </tr>
