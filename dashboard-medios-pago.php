...
<div class='update-nag'>Error al listar los medios disponibles ofrecidos por Pagopar, esto muy seguramente se deba a una mala configuración del plugin. <a target="_blank" href="<?php echo esc_html(get_admin_url());?>admin.php?page=wc-settings&tab=checkout&section=pagopar">Favor configure el plugin correctamente</a>.</div>
<div style="clear:both;"></div>
<?php
endif;
?>
...
<div class="wrap" identificador="zona_<?php echo esc_attr($value2['instance_id']);?>">
    ...
    <table class="wp-list-table widefat fixed striped posts">
      <tr>
		...
		?>
		<tr>
			<td><?php echo esc_html($value['titulo']);?></td>
			<td><?php echo esc_html($value['descripcion']);?></td>
			<td><?php echo esc_html($value['monto_minimo']);?></td>
		</tr>		
		<?php endforeach; ?>
...
<br />
<br />
<div class="wrap" identificador="zona_<?php echo esc_html($value2['instance_id']);?>">
	<div>
    ...
    <table class="wp-list-table widefat fixed striped posts">
      <tr>
		...
		<tr>
                    ...
                    <td><?php echo esc_html($datosComercio['resultado']['modo_pago_denominacion']); ?></td>
		</tr>	                
		...
		<tr>
                    <td>Entorno</td>
                    <td><?php echo esc_html($datosComercio['resultado']['entorno']); ?></td>
		</tr>                
